...
$sql2 = "select users.id, users.nombre, users.apellidos, users.telefono, vehiculo.nombre, vehiculo.placa from users, user_vehiculo, vehiculo
where users.id=user_vehiculo.id_user and vehiculo.id=user_vehiculo.id_vehiculo ";
                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                          ...
                          <td><?php echo $datos2['nombre']; ?></td>
                          <td><?php echo $datos2['placa']; ?></td>
                          <td><button class='btn btn-success' id='aceptar<?php echo $i ?>'>Actualizar</button> </td>
                         ...
                         <script>
                              $("#aceptar<?php echo $i ?>").click(function(){
                                 // alert("Bien<?php echo $i ?>")
                                  ...
                                  $("#contenido").empty();
                                  $("#contenido").load('actualizar?id=<?php echo $datos2['id'] ?>');
                                  $("#contenido").show();
                              });
