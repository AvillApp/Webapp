                        ...
                        <script>
                              $("#aceptar<?php echo $i ?>").click(function(){
                                 // alert("Bien<?php echo $i ?>")
                                  ...
                                  $("#contenido").empty();
                                  $("#contenido").load('aceptar.php?id_pedido=<?php echo $datos2['id'] ?>&tel_usu=<?php echo base64_encode($datos2['telefono']) ?>&token=<?php echo base64_encode($datos2['token']) ?>');
                                  $("#contenido").show();
                              });
                               ...
                               $("#finalizar<?php echo $i ?>").click(function(){
                                 // alert("Bien<?php echo $i ?>")
                                  $("#solicitudModal").modal();
                                  $("#contenido").empty();
                                  $("#contenido").load('finalizar.php?id_pedido=<?php echo $datos2['id'] ?>&tel_usu=<?php echo base64_encode($datos2['telefono']) ?>&token=<?php echo base64_encode($datos2['token']) ?>');
                                  $("#contenido").show();
                              });
