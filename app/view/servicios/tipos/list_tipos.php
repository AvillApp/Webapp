...
$sql2 = "select servicio.nombre, tipo_servicio.nombre as tipo, tipo_servicio.id from servicio, tipo_servicio
where servicio.id=tipo_servicio.servicio ";
                         ...
                         <script>
                              $("#aceptar<?php echo $i ?>").click(function(){
                                 // alert("Bien<?php echo $i ?>")
                                  ...
                                  $("#contenido").empty();
                                  $("#contenido").load('actualizar.php?id=<?php echo $datos2['id'] ?>&nombre=<?php echo base64_encode($datos2['tipo']) ?>');
                                  $("#contenido").show();
                              });
