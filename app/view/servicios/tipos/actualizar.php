...
// consultamos para mostrar solo los conductores disponibles
 $sql ="select * from tipo_servicio where id='".$_GET['id']."' ";
        ...
        ?>
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class='form-control' id='nombre2' value="<?php echo base64_decode($_GET['nombre']) ?>"  />
                </div> 
            </form>
...
$("#confirmar").click(function(){
                ...
                var servicio = $("#tipo2").val();


                var datos='servicios='+1+'&nombre='+nombre+'&id='+id+'&update_tipo='+1+'&servicio='+servicio;
